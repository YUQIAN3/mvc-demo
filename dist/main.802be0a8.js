...
var $tanContent = (0, _jquery2.default)('#app2 .tab-content');

$tabBar.on("click", "li", function (e) {
  var $li = (0, _jquery2.default)(e.currentTarget);
  $li.addClass('selected').siblings().removeClass('selected');
  var index = $li.index();
  $tanContent.children().eq(index).addClass('active').siblings().removeClass('active');
});
...
//# sourceMappingURL=/main.802be0a8.map